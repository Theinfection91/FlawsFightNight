...
{
    public class DeleteTeamHandler : CommandHandler
    {
        ...
        public DeleteTeamHandler(EmbedFactory embedFactory, GitBackupService gitBackupService, MatchService matchService, TeamService teamService, TournamentService tournamentService) : base("Remove Team")
        {
