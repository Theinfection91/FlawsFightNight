...
{
    public class SetTeamsChannelHandler : CommandHandler
    {
        private EmbedFactory _embedFactory;
        private GitBackupService _gitBackupService;
        private TournamentService _tournamentService;

        public SetTeamsChannelHandler(EmbedFactory embedFactory, GitBackupService gitBackupService, TournamentService tournamentService) : base("Set Teams Channel")
        {
        ...
        public async Task<Embed> SetTeamsChannelProcess(string tournamentId, IMessageChannel channel)
        {
            ...
            return _embedFactory.SetTeamsChannelSuccess(channel, tournament);
        }
    }
}
