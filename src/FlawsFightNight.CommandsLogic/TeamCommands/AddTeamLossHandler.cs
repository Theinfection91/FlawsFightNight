...
{
    public class AddTeamLossHandler : CommandHandler
    {
        ...
        public AddTeamLossHandler(EmbedFactory embedFactory, GitBackupService gitBackupService, TeamService teamService, TournamentService tournamentService) : base("Add Loss")
        {
