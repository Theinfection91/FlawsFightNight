...
{
    public class CancelChallengeAutocomplete : AutocompleteHandler
    {
        private readonly AutocompleteCache _cache;
        public CancelChallengeAutocomplete(AutocompleteCache cache)
        {
            _cache = cache;
        }
            ...
            IServiceProvider services)
        {
            ...
            var suggestions = string.IsNullOrWhiteSpace(currentInput)
                                ? _cache.GetTeamsForCancelChallenge("")
                                : _cache.GetTeamsForCancelChallenge(currentInput);
