...
{
    public class LadderTeamNameAutocomplete : AutocompleteHandler
    {
        private readonly AutocompleteCache _cache;
        public LadderTeamNameAutocomplete(AutocompleteCache cache)
        {
            _cache = cache;
        }
            ...
            IServiceProvider services)
        {
            ...
            var suggestions = string.IsNullOrWhiteSpace(currentInput)
                                ? _cache.GetLadderTeamNames("")
                                : _cache.GetLadderTeamNames(currentInput);
